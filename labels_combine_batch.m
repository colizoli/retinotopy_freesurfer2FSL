function [] = labels_combine_batch()
% Merge all parts of retinotopic areas together and hemispheres per subject.
% Creates a batch script ('BatchFile_labels_combine.txt') to be processed from the terminal
...
% print to file
batch_file = strcat(dir_firstlevel_home, {'/'}, 'BatchFile_labels_combine.txt'); % name of bash script
...
%count how many folders are in the Current directory and get folder names
	...
	for i=1:number_subjects 
       ...
       %V2d and V2v Left = V2 Left
        	lh_v2d = strcat(current_dir, '/labels2vol/vol_lh.V2d.label.nii.gz'); 
        	lh_v2d = char(lh_v2d);
                
        	lh_v2v = strcat(current_dir, '/labels2vol/vol_lh.V2v.label.nii.gz'); 
        	lh_v2v = char(lh_v2v);
        
        	lh_v2 = strcat(current_dir, '/labels2vol/vol_lh.V2.label.nii.gz');  
        	lh_v2 = char(lh_v2);
      ...
      % V2d and V2v Right = V2 Right    
            rh_v2d = strcat(current_dir, '/labels2vol/vol_rh.V2d.label.nii.gz'); 
        	rh_v2d = char(rh_v2d);
                
        	rh_v2v = strcat(current_dir, '/labels2vol/vol_rh.V2v.label.nii.gz'); 
        	rh_v2v = char(rh_v2v);
        
        	rh_v2 = strcat(current_dir, '/labels2vol/vol_rh.V2.label.nii.gz');
        	rh_v2 = char(rh_v2);
        ...
        % V2         
        	v2 = strcat(current_dir, '/labels2vol/vol_V2.label.nii.gz'); 
        	v2 = char(v2);
       	...
       	% V3d and V3v Left = V3 Left
        	...
        	lh_v3v = strcat(current_dir, '/labels2vol/vol_lh.V3v.label.nii.gz'); 
        	lh_v3v = char(lh_v3v);
        
        	lh_v3d = strcat(current_dir, '/labels2vol/vol_lh.V3d.label.nii.gz');  
        	lh_v3d = char(lh_v3d);
        	
        	lh_v3 = strcat(current_dir, '/labels2vol/vol_lh.V3.label.nii.gz');  
        	lh_v3 = char(lh_v3);
       ...
       % V3d and V3v Right = V3 Right
        	...
        	rh_v3v = strcat(current_dir, '/labels2vol/vol_rh.V3v.label.nii.gz'); 
        	rh_v3v = char(rh_v3v);
        
        	rh_v3d = strcat(current_dir, '/labels2vol/vol_rh.V3d.label.nii.gz');  
        	rh_v3d = char(rh_v3d);
        	
        	rh_v3 = strcat(current_dir, '/labels2vol/vol_rh.V3.label.nii.gz');  
        	rh_v3 = char(rh_v3);
         ...
         % V3         
        	v3 = strcat(current_dir, '/labels2vol/vol_V3.label.nii.gz'); 
        	v3 = char(v3);
         ...
         % V3AB
        	...
        	lh_v3a = strcat(current_dir, '/labels2vol/vol_lh.V3AB.label.nii.gz'); 
        	lh_v3a = char(lh_v3a);              
        	
        	rh_v3a = strcat(current_dir, '/labels2vol/vol_rh.V3AB.label.nii.gz');  
        	rh_v3a = char(rh_v3a);
            
            v3ab = strcat(current_dir, '/labels2vol/vol_V3AB.label.nii.gz');  
        	v3ab = char(v3ab);
          ...
          % V1  
            lh_v1 = strcat(current_dir, '/labels2vol/vol_lh.V1.label.nii.gz'); 
        	lh_v1 = char(lh_v1);
                
        	rh_v1 = strcat(current_dir, '/labels2vol/vol_rh.V1.label.nii.gz'); 
        	rh_v1 = char(rh_v1);
        	
            v1 = strcat(current_dir, '/labels2vol/vol_V1.label.nii.gz'); 
        	v1 = char(v1);
          ...
          % V4  
            lh_v4 = strcat(current_dir, '/labels2vol/vol_lh.V4.label.nii.gz'); 
        	lh_v4 = char(lh_v4);
                
        	rh_v4 = strcat(current_dir, '/labels2vol/vol_rh.V4.label.nii.gz'); 
        	rh_v4 = char(rh_v4);
        	
            v4 = strcat(current_dir, '/labels2vol/vol_V4.label.nii.gz'); 
        	v4 = char(v4);
