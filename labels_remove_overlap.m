function [] = labels_remove_overlap()
% Removes all overlapping voxels in these regions of interest
% Creates a batch script ('BatchFile_labels_remove_overlap.txt') to be processed from the terminal
% 
...
% print to file
batch_file = strcat(dir_firstlevel_home, {'/'}, 'BatchFile_labels_remove_overlap.txt'); % name of bash script
...
%count how many folders are in the Current directory and get folder names
	...
	for i=1:number_subjects
       ...
       %V1 -V2 -V3 -V4 -V3AB
        	v1 = strcat(current_dir, '/labels2vol/mask_vol_V1.label.nii.gz'); 
        	v1 = char(v1);
                
        	v2 = strcat(current_dir, '/labels2vol/mask_vol_V2.label.nii.gz'); 
        	v2 = char(v2);
            
            v3 = strcat(current_dir, '/labels2vol/mask_vol_V3.label.nii.gz'); 
        	v3 = char(v3);
            
            v4 = strcat(current_dir, '/labels2vol/mask_vol_V4.label.nii.gz'); 
        	v4 = char(v4);
            
            v3ab = strcat(current_dir, '/labels2vol/mask_vol_V3AB.label.nii.gz'); 
        	v3ab = char(v3ab);
            
            new = strcat(current_dir, '/overlap_removed/V1_vol_mask.nii.gz'); 
            new = char(new);
       ...
       %V2 -V1 -V3 -V4 -V3AB
            ...
            new = strcat(current_dir, '/overlap_removed/V2_vol_mask.nii.gz'); 
            new = char(new);
       ...
       %V3 -V1 -V2 -V4 -V3AB
            ...
            new = strcat(current_dir, '/overlap_removed/V3_vol_mask.nii.gz'); 
            new = char(new);
        ...
        %V4 -V1 -V2 -V3 -V3AB
            ...
            new = strcat(current_dir, '/overlap_removed/V4_vol_mask.nii.gz'); 
            new = char(new);
        ...
        %V3AB -V1 -V2 -V3 -V4
            ...
            new = strcat(current_dir, '/overlap_removed/V3AB_vol_mask.nii.gz'); 
            new = char(new);
